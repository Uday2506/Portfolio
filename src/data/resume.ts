...
export const profile = {
  name: 'Battula Uday Kiran',
  eyebrow: 'B.Tech CSE · IIT Guwahati',
  headline: 'I build software, then go run the room it ships into.',
  subhead:
...
export const stats = [
  ...
  { value: '60,000→100', label: 'national applicant pool shortlisted for Technothlon Mains' },
]
...
export const experience: ExperienceItem[] = [
  ...
  },
  {
    ...
    date: '2026',
    bullets: [
      'Coordinated registrations and audience flow on-site, acting as point of contact for attendees.',
...
export const alsoLed = [
  {
    ...
    detail: 'Organised a finance-based event, Fauna Fantastico, for the top 50 finalists.',
    date: '2025',
  },
  {
    role: 'Invigilator, JDST – Dakshana',
    detail: 'Organized an exam for Navodaya students at JNV East Godavari.',
    date: '2025',
  },
]

export type ProjectItem = {
  id: 'technothlon' | 'ytDownloader' | 'nnAccelerator'
  category: string
  title: string
  org: string
  date: string
...
export const skills: SkillGroup[] = [
  ...
  },
  {
    ...
    description: 'Version control, both major OS environments, and hardware description at an elementary level.',
...
export const achievements = [
  {
    value: 'Top 10',
    label: 'PTC Campus Contest, among all campus participants (PTC 2026)',
    date: '2026',
  },
  {
    value: 'Top 1.95%',
